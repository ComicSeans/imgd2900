...
//Last modified: Sun, Dec 14, 2014 09:32:12 AM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 180.87541950016021 78.564995378116208 -58.222209367131128 ;
	setAttr ".r" -type "double3" -9.9383527303219079 460.19999999977432 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 210.91336614410702;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" -37.798217345262643 68.621845096064817 8.3157908625248176 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".cl" -type "float3" 1 0.99443048 0.9214313 ;
	setAttr ".in" 0.67669171094894409;
	setAttr ".urs" no;
	setAttr ".us" no;
createNode transform -n "persp1";
	setAttr ".t" -type "double3" 50.05864873779008 46.588145166171948 20.36987086171078 ;
	setAttr ".r" -type "double3" 0.86164727039461986 72.600000000006816 -4.9855573070441023e-016 ;
createNode camera -n "persp1Shape" -p "persp1";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 48.592368592999513;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode transform -n "pointLight2";
	setAttr ".t" -type "double3" -39.639596040151233 71.391887292766484 -58.94034400496254 ;
...
createNode lambert -n "Wall";
	...
	setAttr ".ambc" -type "float3" 0.44444954 0.44444954 0.44444954 ;
...
createNode polyTweak -n "polyTweak6";
	setAttr ".uopa" yes;
	setAttr -s 11 ".tk[101:111]" -type "float3"  0 21.048233032 0 0 21.048233032
		 0 0 21.048233032 0 0 21.048233032 0 0 21.048233032 0 0 21.048233032 0 0 21.048233032
		 0 0 21.048233032 0 0 21.048233032 0 0 21.048233032 0 0 21.048233032 0;
createNode blinn -n "blinn1";
	setAttr ".c" -type "float3" 1 1 1 ;
	setAttr ".it" -type "float3" 0.73504233 0.73504233 0.73504233 ;
